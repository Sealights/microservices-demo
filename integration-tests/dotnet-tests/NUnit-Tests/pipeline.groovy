        ...
        stage('download DotNet agent') {
            steps{
                script{
                    ...
                    dotnet ./sl-dotnet-agent/SL.DotNet.dll testListener --workingDir .  --target dotnet   --testStage "NUnit-Tests" --labId ${params.SL_LABID} --token ${params.SL_TOKEN} --targetArgs "test integration-tests/dotnet-tests/NUnit-Tests/"
