...
pipeline {
  ...
  parameters {
    ...
    string(name: 'BRANCH', defaultValue: 'java-gradle', description: 'Branch to clone (java-gradle)')
    string(name: 'CHANGED_BRANCH', defaultValue: 'changed1', description: 'Branch to clone (java-gradle)')
    booleanParam(name: 'enable_dd', defaultValue: false, description: 'This parameter is used for enable Datadog agent')
    string(name: 'BUILD_BRANCH', defaultValue: 'java-gradle', description: 'Branch to Build images that have the creational LAB_ID (send to gradle branch to build)')
