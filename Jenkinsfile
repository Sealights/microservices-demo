...
pipeline {
  ...
  parameters {
    string(name: 'APP_NAME', defaultValue: 'java-agent-app', description: 'name of the app (integration build)')
    string(name: 'BRANCH', defaultValue: 'java-agent', description: 'Branch to clone (ahmad-branch)')
    ...
    string(name: 'BUILD_BRANCH', defaultValue: 'java-agent', description: 'Branch to Build images that have the creational LAB_ID (send to ahmad branch to build)')
