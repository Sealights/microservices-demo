...
pipeline {
  ...
  parameters {
    string(name: 'APP_NAME', defaultValue: 'Add_method-BTQ', description: 'name of the app (integration build)')
    string(name: 'BRANCH', defaultValue: 'add_methods', description: 'Branch to clone')
    string(name: 'CHANGED_BRANCH', defaultValue: 'changed', description: 'Branch to run changed')
    string(name: 'BUILD_BRANCH', defaultValue: 'add_methods', description: 'Branch to Build images that have the creational LAB_ID (send to wahbi branch to build)')
