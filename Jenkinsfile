...
pipeline {
  ...
  parameters {
    string(name: 'APP_NAME', defaultValue: 'maven-BTQ', description: 'name of the app (integration build)')
    string(name: 'BRANCH', defaultValue: 'maven-branch', description: 'Branch to clone (maven-branch)')
    string(name: 'CHANGED_BRANCH', defaultValue: 'changed1', description: 'Branch to clone (maven-branch)')
    booleanParam(name: 'enable_dd', defaultValue: false, description: 'This parameter is used for enable Datadog agent')
    string(name: 'BUILD_BRANCH', defaultValue: 'maven-branch', description: 'Branch to Build images that have the creational LAB_ID (send to maven branch to build)')
    ...
    string(name: 'BUILD_NAME', defaultValue: 'maven-1', description: 'build name')
